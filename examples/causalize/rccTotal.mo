model rlc  
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor2(C = 1, v(start = 1));
equation
  connect(capacitor1.p, resistor1.p);
  connect(capacitor2.p, capacitor1.p);
  connect(capacitor1.n, capacitor2.n);
